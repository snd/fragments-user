...
module.exports.validateSignup = function(waechter, schemaUserShared, schemaUserRightsForbidden, idToSchemaUserTakenAsync) {
  return waechter.schemasToLazyAsyncValidator(schemaUserShared, schemaUserRightsForbidden, idToSchemaUserTakenAsync());
};

module.exports.validateUserInsert = function(waechter, schemaUserShared, idToSchemaUserTakenAsync) {
  return waechter.schemasToLazyAsyncValidator(schemaUserShared, {
    rights: waechter.maybe(waechter.string)
  }, idToSchemaUserTakenAsync());
};

module.exports.validateSelfUpdate = function(waechter, schemaUserShared, schemaUserRightsForbidden, idToSchemaUserTakenAsync) {
  return function(user, id) {
    return waechter.schemasToLazyAsyncValidator(schemaUserShared, schemaUserRightsForbidden, idToSchemaUserTakenAsync(id))(user);
  };
};

module.exports.validateUserUpdate = function(waechter, schemaUserShared, idToSchemaUserTakenAsync) {
  return function(user, id) {
    return waechter.schemasToLazyAsyncValidator(schemaUserShared, {
      rights: waechter.maybe(waechter.string)
