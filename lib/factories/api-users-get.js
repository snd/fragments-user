module.exports.apiUsersGet = function(urlApiUsers, GET) {
  return GET(urlApiUsers(), function(userTable, query, siv, endJSON, endForbidden, endForbiddenTokenRequired, endForbiddenInsufficientRights, endUnprocessableJSON, canReadUsers, omitPassword, currentUser, _) {
    var sql;
    if (currentUser == null) {
